                            ...
                            <div class="field-pair" style="padding-top: 0;">
                                <label class="nocheck">
                                    ...
                                    <span class="component-desc">
                                        ...
                                        <img src="${sbRoot}/images/legend16.png?v=${sickbeard.CUR_COMMIT_HASH[:6]}" width="16" height="16" alt="[Toggle Key]" id="show_naming_key" title="Toggle Naming Legend" class="legend" class="legend" />
                                    </span>
                                </label>
                                <label class="nocheck">
                                    <span class="component-title">&nbsp;</span>
                                ...
                                <div class="field-pair">
                                    <label class="nocheck">
                                        ...
                                        <span class="component-desc">
                                            ...
                                            <img src="${sbRoot}/images/legend16.png?v=${sickbeard.CUR_COMMIT_HASH[:6]}" width="16" height="16" alt="[Toggle Key]" id="show_naming_abd_key" title="Toggle ABD Naming Legend" class="legend" />
                                        </span>
                                    </label>
                                </div>
                                ...
                                <div class="field-pair" style="padding-top: 0;">
                                    <label class="nocheck">
                                        ...
                                        <span class="component-desc">
                                            ...
                                            <img src="${sbRoot}/images/legend16.png?v=${sickbeard.CUR_COMMIT_HASH[:6]}" width="16" height="16" alt="[Toggle Key]" id="show_naming_sports_key" title="Toggle Sports Naming Legend" class="legend" />
                                        </span>
                                    </label>
                                </div>
                                ...
                                <div class="field-pair" style="padding-top: 0;">
                                    <label class="nocheck">
                                        ...
                                        <span class="component-desc">
                                            ...
                                            <img src="${sbRoot}/images/legend16.png?v=${sickbeard.CUR_COMMIT_HASH[:6]}" width="16" height="16" alt="[Toggle Key]" id="show_naming_anime_key" title="Toggle Anime Naming Legend" class="legend" />
                                        </span>
                                    </label>
                                </div>
