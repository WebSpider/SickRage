                        ...
                        % for curService in sickbeard.subtitles.sortedServiceList():
                            <li class="ui-state-default" id="${curService['name']}">
                                ...
                                <a href="${anon_url(curService['url'])}" class="imgLink" target="_new">
                                    <img src="${sbRoot}/images/subtitles/${curService['image'] + "?v=" + sickbeard.CUR_COMMIT_HASH[:6]}" alt="${curService['url']}" title="${curService['url']}" width="16" height="16" style="vertical-align:middle;"/>
                                </a>
